    ...
    consumeAttribute(source, node, token, next) {
        ...
        for (const attr of iterator) {
            const event = {
                ...
                keyLocation,
                valueLocation,
                meta: (_b = meta === null || meta === void 0 ? void 0 : meta.attributes[attr.key]) !== null && _b !== void 0 ? _b : null,
            };
...
export { Attribute as A, ruleExists as B, Config as C, DOMNode as D, EventHandler as E, compatibilityCheckImpl as F, codeframe as G, HtmlValidate as H, name as I, bugs as J, MetaCopyableProperty as M, NodeClosed as N, Presets as P, ResolvedConfig as R, Severity as S, TextNode as T, UserError as U, Validator as V, WrappedError as W, ConfigError as a, ConfigLoader as b, StaticConfigLoader as c, deepmerge$1 as d, ensureError as e, DOMTokenList as f, getFormatter as g, DOMTree as h, ignore$1 as i, DynamicValue as j, HtmlElement as k, NodeType as l, NestedError as m, SchemaValidationError as n, MetaTable as o, TextContent$1 as p, Rule as q, TextClassification as r, staticResolver as s, classifyNodeText as t, keywordPatternMatcher as u, version as v, sliceLocation as w, Reporter as x, definePlugin as y, Parser as z };
